...
<div id="header">
    ...
    <div id="headerBottom">
        <a href="index.php"><div class="headerLinkDiv"><p class="headerLinkP">Home</p></div></a>
        <div class="headerLinkDivActive"><p class="headerLinkP">Sign Up</p></div>
        <a href="emailOptions.php"><div class="headerLinkDiv"><p class="headerLinkP">Email Options</p></div></a>
        <a href="storeLocator.php"><div class="headerLinkDiv"><p class="headerLinkP">Find a Store</p></div></a>
    </div>
...
<?php
    // The following code will activate when the submit button is clicked
    if (isset($_POST['submit'])) {
        ...
        // Checks to see if all the form inputs are filled out
                ...
                if (strlen($email) <= 48 && strlen($email) >= 1) {
                    if (strlen($first_name) <= 24 && strlen($first_name) >= 1) {
                        if (strlen($last_name) <= 24 && strlen($last_name) >= 1) {
                            ...
                            // The user has inserted all the correct information into the form fields and we are ready to connect to the database
                            // Connect to database
                            ...
                            if ($results){
                                ...
                                echo '<p>Your account has been successfully added!</p><br />';
                                echo '<p><strong>First Name:</strong>'. $first_name . '</p><br />';
                                echo '<p><strong>Last Name:</strong>' . $last_name . '</p><br />';
                                echo '<p><strong>Email:</strong>' . $email . '</p><br />';
                                echo '<p><strong>Location:</strong>' . $location . '</p><br />';
                                echo '<p><strong>Password:</strong>' . $password . '</p><br />';
                                echo '<p>Thanks for registering! Click <a href="signIn.php">HERE</a> to sign in. (Sign in required for security reasons)</p><br />';
                            }
                            else {
                                echo '<p>There was an error creating your account, please try again.</p><br />';
                            }
                            ...
                            echo '<p>Please enter a valid last name which contains between 1 and 24 characters.</p><br />';
                        }
                    }
                    else {
                        echo '<p>Please enter a valid first name which contains between 1 and 24 characters.</p><br />';
                    }
                }
                else {
                    echo '<p>Please enter a valid email which contains between 1 and 48 characters.</p><br />';
                }
            }
            else {
                echo '<p>Please enter a valid password which contains between 1 and 16 characters.</p><br />';
            }
        }
        else {
